...
import codigos.ADTS.ArregloADT;
...
public class NominaADT {
    ...
    public static void main(String[] args) {
        /*Guardamos los datos del archivo en una matriz (lista de listas) y generamos el ArregloADT que contendra a los
        empleados.*/
        ArrayList<ArrayList<String>> matriz = new ArrayList();
        LectorArchivo.leerArchivo("C:\\Users\\rodol\\Downloads\\junio.dat", matriz);
        ArregloADT<Empleado> nomina = new ArregloADT(matriz.size() - 1);
        
        /*Almacenamos cada empleado en el ArregloADT nomina con los datos del archivo que vienen contenidos 
        en matriz.*/
